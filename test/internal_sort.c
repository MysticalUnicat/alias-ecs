...
int _is_same(uint32_t count, const uint32_t * a, const uint32_t * b) {
  int r = 1;
...
int _compar_uint32(const void * ap, const void * bp) {
  uint32_t a = *(uint32_t *)ap;
  uint32_t b = *(uint32_t *)bp;
  return (int)a - (int)b;
}

int _compar_uint32_ud(void * ud, const void * ap, const void * bp) {
  (void)ud;
  uint32_t a = *(uint32_t *)ap;
  uint32_t b = *(uint32_t *)bp;
  return (int)a - (int)b;
